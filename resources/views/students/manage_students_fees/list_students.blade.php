    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item">{{__('students/list_students.Home_Fee')}}</li>
          <li class="breadcrumb-item active"><a href="{{route('students_fees')}}">{{__('students/list_students.Screen_Fee')}}</a></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title mr-2">
                <a href="#">
                    <button type="button" class="btn btn-block btn-primary">{{__('students/list_students.import_fees')}}</button>
                </a>
              </h3>
              <h3 class="card-title mr-2">
                <a href="#">
                    <button type="button" class="btn btn-block bg-success">{{__('students/list_students.export_fees')}}</button>
                </a>
              </h3>
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="project-actions text-right">
                    <a class="btn btn-primary btn-sm" href="{{route('view_fee')}}">
                        <i class="fas fa-eye">
                        </i>
                        {{__('shared/shared.View')}}
                    </a>
                    <a class="btn btn-success btn-sm" href="{{route('add_fee')}}">
                      <i class="fas fa-folder">
                      </i>
                      {{__('shared/shared.Add')}}
                    </a>
                    <a class="btn btn-info btn-sm" href="{{route('edit_fee')}}">
                        <i class="fas fa-pencil-alt">
                        </i>
                        {{__('shared/shared.Edit')}}
                    </a>
                    <a class="btn btn-danger btn-sm text-white" href="{{route('delete_fee')}}">
