    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item">{{__('students/edit_student.Home_Fee')}}</li>
          <li class="breadcrumb-item active"><a href="{{route('students_fees')}}">{{__('students/edit_student.Screen_Fee')}}</a></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
