                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" name="birthdate"
                                            value="{{ old('birthdate') ? date('m/d/Y', strtotime(old('birthdate'))) : '' }}"
                                ...
                                <table class="table table-hover text-nowrap" id="dynamicAddRemove">
                                                ...
                                                <div class="col-3">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <span
                                                                class="input-group-text">{{ __('students/add_student.Student_Fees') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tbody id="dynamicAddRemove_2">
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" name="B[0][B]" class="form-control"
                                                        placeholder="{{ __('students/add_student.Coordination_Fees') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" name="C[0][C]" class="form-control"
                                                        placeholder="{{ __('students/add_student.Bond_No') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="D[0][D]" class="form-control"
