                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <option value="{{$student->registration_type}}"
                                                    @if (old('registration_type') == $student->registration_type) selected @endif>{{$student->registration_type}}
                                                </option>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nationality_country"
                                            value="{{ $student->nationality_country}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $student->gender }}"
                                                    @if (old('gender') == $student->gender) selected @endif>{{ $student->gender }}
                                                </option>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $student->blood_type }}"
                                                    @if (old('blood_type') == $student->blood_type) selected @endif>{{ $student->blood_type }}
                                                </option>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="high_school_name"
                                            value="{{$student->high_school_name}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="high_school_exam_id"
                                            value="{{$student->high_school_exam_id}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="high_school_city"
                                            value="{{$student->high_school_city}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="high_school_district"
                                            value="{{$student->high_school_district}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="english_birth_place"
                                            value="{{$student->english_birth_place}}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="total_percentage"
                                            value="{{$student->total_percentage}}" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <option value="{{$student->last_degree}}"
                                                    @if (old('last_degree') == $student->last_degree) selected @endif>{{ $student->last_degree}}
                                                </option>
                                            @foreach ($academicLevels as $key => $level)
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="graduation_year"
                                            value="{{$student->graduation_year}}" class="form-control"
                                            placeholder="{{ __('students/add_student.Graduation_Year') }}">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="graduation_country"
                                            value="{{ $student->graduation_country}}" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fees" value="{{$student->fees}}"
                                            class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input name="notes" value="{{$student->notes}}" type="text" class="form-control" rows="3" placeholder="Enter ...">
                                    </div>
                                </div>
                            </div>
                        </div>
