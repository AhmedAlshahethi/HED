                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <select name="department_id" class="form-control">
                      <option value="{{ $student->department_id }}" @if (old('department_id') == $student->department_id) selected @endif>
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <select name="blood_type" class="form-control">
                      <option value="{{ $student->blood_type }}" @if (old('blood_type') == $student->blood_type) selected @endif>
                        {{ $student->blood_type }}
                      </option>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text" name="high_school_max_score" value="{{ $student->high_school_max_score }}"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text" name="major_name" value="{{ $student->major_name }}" class="form-control"
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <select name="last_degree" class="form-control">
                      <option value="{{ $student->last_degree }}" @if (old('last_degree') == $student->last_degree) selected @endif>
                        {{ $student->last_degree }}
                      </option>
                      @foreach ($academicLevels as $key => $level)
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input name="notes" value="{{ $student->notes }}" type="text" class="form-control"
