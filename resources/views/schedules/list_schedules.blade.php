                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ route('schedules') }}">{{ __('schedules/list_schedules.Screen') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('add_schedule') }}">
                                    <button type="button"
                                        class="btn btn-block btn-primary">{{ __('schedules/list_schedules.Add_Schedule') }}</button>
                                </a>
                            </h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('view_schedule', $schedule) }}">
                                                    <i class="fas fa-eye">
                                                    </i>
                                                    {{ __('shared/shared.View') }}
                                                </a>
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('edit_schedule', $schedule) }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>
                                                    {{ __('shared/shared.Edit') }}
                                                </a>
                                                <a class="btn btn-danger btn-sm text-white" id="delete"
                                                    href="{{ route('delete_schedule', $schedule->id) }}">
