  ...
  <div class="wrapper">
          ...
          <div class="dropdown-menu dropdown-menu-right p-0">
            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
              <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                ...
                <i class="flag-icon flag-icon-{{ $localeCode == 'en' ? 'us' : 'ye' }} mr-2"></i>
                {{ $properties['native'] }}
              </a>
            @endforeach
          </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="{{ asset('dist/img/FCIT.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
  ...
  {{-- <script>
        ...
        $("#dynamic-ar_5").click(function() {
            ...
            $("#dynamicAddRemove_5").append(`<tr>
                                        <td>
                                          <div>
                                            <input type="text" name="journal_name[` + i + `][journal_name]" class="form-control" placeholder="{{ __('students_thesis/journal.Journal_Name') }}" value="{{ old("journal_name.${i}.journal_name") }}">
                                          </div>
                                        </td>
                                        <td>
                                          <div>
                                            <input type="text" name="journal_link[` + i + `][journal_link]" class="form-control" placeholder="{{ __('students_thesis/journal.Journal_Link') }}" value="{{ old("journal_link.${i}.journal_link") }}">
                                          </div>
                                        </td>
                                        <td>
                                            <div>
                                              <input type="text" name="notes[` + i + `][notes]" class="form-control" placeholder="{{ __('students_thesis/journal.Notes') }}" value="{{ old("notes.${i}.notes") }}">
                                            </div>
                                          </td>
                                        <td class="project-actions text-right">
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#dynamic-ar_5").click(function() {
        ...
        <td>
            <div>
                <input type="text" name="journal_name[${i}][journal_name]" class="form-control"
        ...
        <td>
            <div>
                <input type="text" name="journal_link[${i}][journal_link]" class="form-control"
        ...
        <td>
            <div>
                <input type="text" name="notes[${i}][notes]" class="form-control"
        ...
        $("#dynamicAddRemove_5").append(newRow);
      });
