    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item">{{__('students_thesis/shared.Home_Journal.Delete_Journal')}}</li>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title" style="float: {{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'right' :  'left'}}">{{__('students_thesis/shared.Journal_Title.Delete_Journal_Data')}}</h3>
                </div>
                <!-- /.card-header -->
                            ...
                            <table class="table table-head-fixed text-nowrap" id="dynamicAddRemove">
                                ...
                                <tbody id="dynamicAddRemove_5">
                                    <tr>
                                        <td>
                                          <div>
                                            <input type="text" name="journal_name[0][journal_name]" class="form-control" placeholder="{{__('students_thesis/journal.Journal_Name')}}" disabled>
                                          </div>
                                        </td>
                                        <td>
                                          <div>
                                            <input type="text" name="journal_link[0][journal_link]" class="form-control" placeholder="{{__('students_thesis/journal.Journal_Link')}}" disabled>
                                          </div>
                                        </td>
                                        <td>
                                            <div>
                                              <input type="text" name="notes[0][notes]" class="form-control" placeholder="{{__('students_thesis/journal.Notes')}}" disabled>
                                            </div>
                                          </td>
