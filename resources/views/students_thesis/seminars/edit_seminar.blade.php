        ...
        <div class="container-fluid">
          ...
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title" style="float: {{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'right' :  'left'}}">{{__('students_thesis/shared.Seminar_Title.Edit_Seminar_Data')}}</h3>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label for="customCheckbox1" class="custom-control-label">{{__('students_thesis/seminar.Approval_of_the_Seminar')}}</label>
                      </div>
                </div>                
              </div>
            </div>
