    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item">{{__('students_thesis/shared.Home_Discussion.Edit_Discussion')}}</li>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title" style="float: {{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'right' :  'left'}}">{{__('students_thesis/shared.Discussion_Title.Edit_Discussion_Data')}}</h3>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.Score')}}">
                          </div>
                    </div>
                </div>   
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__('students_thesis/discussion.Approval_of_the_ruling_result-Section')}}</label>
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              ...
                              placeholder="{{__('students_thesis/discussion.Approval_of_the_ruling_result-Section')}}"/>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.Section_Approvement_Number')}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__('students_thesis/discussion.Approval_of_the_ruling_result-College')}}</label>
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"
                              placeholder="{{__('students_thesis/discussion.Approval_of_the_ruling_result-College')}}"/>
                              <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                  <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                              </div>
                          </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.College_Approvement_Number')}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__('students_thesis/discussion.Discussion_Date')}}</label>
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"
                              placeholder="{{__('students_thesis/discussion.Discussion_Date')}}"/>
                              <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                  <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                              </div>
                          </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__("students_thesis/discussion.Referee's_Decision_Number")}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.External_Discussant')}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.Internal_Discussant')}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{__('students_thesis/discussion.Discussion_Result')}}">
                          </div>
                    </div>
                </div>
                <div class="col-md-6">
