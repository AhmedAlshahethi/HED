                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ route('instructors') }}">{{ __('instructors/list_instructors.Screen') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('add_instructor') }}">
                                    <button type="button"
                                        class="btn btn-block btn-primary">{{ __('instructors/list_instructors.Add_Instructor') }}</button>
                                </a>
                            </h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                ...
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('profile_instructor', $instructor->id) }}">
                                                    <i class="fas fa-eye">
                                                    </i>
                                                ...
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('edit_instructor', $instructor->id) }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>
                                                    {{ __('shared/shared.Edit') }}
                                                </a>
                                                <a class="btn btn-danger btn-sm text-white" id="delete"
                                                    href="{{ route('delete_instructor', $instructor->id) }}">
