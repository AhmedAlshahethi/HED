                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ route('sections') }}">{{ __('sections/list_sections.Screen') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('add_section') }}">
                                    <button type="button"
                                        class="btn btn-block btn-primary">{{ __('sections/list_sections.Add_Section') }}</button>
                                </a>
                            </h3>
                                    ...
                                    @foreach ($AllDeps as $department)
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                ...
                                                <a class="btn btn-danger btn-sm text-white" id="delete" href="#">
