                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ route('documents_type') }}">{{ __('documents/list_documents.Screen') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('add_document_type') }}">
                                    <button type="button"
                                        class="btn btn-block btn-primary">{{ __('documents/list_documents.Add_Document') }}</button>
                                </a>
                            </h3>
                                        ...
                                        @foreach ($documents_type as $documentType)
                                            ...
                                            <td class="project-actions text-right">
                                                ...
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('edit_document_type', $documentType->id) }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>
                                                    {{ __('shared/shared.Edit') }}
                                                </a>
                                                <a class="btn btn-danger btn-sm text-white" id="delete"
                                                    href="{{ route('delete_document_type', $documentType->id) }}">
