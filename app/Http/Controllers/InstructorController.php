...
class InstructorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        if ($instructor->save()) {
            ...
            $notification = [
                'message' => 'تمت إضافة مدرس بنجاح',
                'alert-type' => 'success'
            ];
            return redirect()->route('instructors')->with($notification);
        }
    }
    ...
    public function edit(Instructor $instructor)
    {
        ...
        return view('instructors.edit_instructor', [
            'instructor' => $instructor, 'Alldepartments' => $departments,
            'genders' => Gender::array(),
            'academicLevels' => AcademicLevel::array()
        ]);
    }
    public function update(Request $request, Instructor $instructor)
    {
        ...
        if ($instructor->update()) {
            $notification = [
                'message' => 'تمت تعديل بيانات مدرس بنجاح',
                'alert-type' => 'success'
            ];
            return redirect()->route('instructors')->with($notification);
        }
    ...
    public function profile(Instructor $instructor)
    {
        ...
        return view('instructors.profile_instructor', [
